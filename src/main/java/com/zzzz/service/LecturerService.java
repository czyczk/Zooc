...
public interface LecturerService {
     ...
     */
    long insert(String enterpriseId, String name, String photoUrl, String introduction) throws LecturerServiceException;

    boolean checkExistenceById(String lecturerId) throws LecturerServiceException;

    Lecturer getById(String lecturerId) throws LecturerServiceException;
     ...
     */
    void update(String targetLecturerId, String name, String photoUrl, String introduction) throws LecturerServiceException;
}
