...
public class CourseServiceImpl implements CourseService {
    ...
    @Override
    @Transactional(rollbackFor = CourseServiceException.class)
    public long insert(String enterpriseId, String name, String detail, String imgUrl, String categoryId, Date releaseTime, String price) throws CourseServiceException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new CourseServiceException(INTERNAL_ERROR);
        }
    }

    @Override
    @Transactional(readOnly = true)
    public Course getById(String courseId) throws CourseServiceException {
    ...
    @Override
    @Transactional(readOnly = true)
    public CourseDetail getVoById(String courseId) throws CourseServiceException {
        // Check if the ID is valid
        checker.rejectIfNullOrEmpty(courseId, new CourseServiceException(EMPTY_COURSE_ID));
        long courseIdLong = checker.parseUnsignedLong(courseId, new CourseServiceException(INVALID_COURSE_ID));
    ...
    @Override
    @Transactional(rollbackFor = CourseServiceException.class)
    public void update(String targetCourseId, String name, String detail, String imgUrl, String categoryId, String releaseTime, String price, String status) throws CourseServiceException {
        // Check if the ID is valid
